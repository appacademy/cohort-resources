...
puts "Creating users..."
mike = User.create(username: "ai_mike", email: "ai_mike@aa.io", affiliation: "AI" )
chris = User.create(username: "ai_chris", email: "ai_chris@aa.io", affiliation: "AI" )
paulo = User.create(username: "ai_paulo", email: "ai_paulo@aa.io", affiliation: "cyborg" )
darren = User.create(username: "darren", email: "darren@aa.io", affiliation: "human" )
diego = User.create(username: "diego", email: "diego@aa.io", affiliation: "human" )
taylor = User.create(username: "taylor", email: "taylor@aa.io", affiliation: "human" )
abbey = User.create(username: "abbey", email: "abbey@aa.io", affiliation: "human" )
