...
/*!******************************************!*\
  !*** ./frontend/actions/todo_actions.js ***!
  \******************************************/
/*! exports provided: RECEIVE_TODOS_AND_STEPS, RECEIVE_TODO, REMOVE_TODO, TODO_ERROR, receiveTodos, receiveTodo, removeTodo, todoError, fetchTodos, fetchTodo, createTodo, updateTodo, deleteTodo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_TODOS_AND_STEPS", function() { return RECEIVE_TODOS_AND_STEPS; });
...
var RECEIVE_TODOS_AND_STEPS = "RECEIVE_TODOS_AND_STEPS";
...
var fetchTodos = function fetchTodos() {
  return function (dispatch) {
    return _util_todo_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchTodos"]().then(function (response) {
      // debugger
...
var stepsReducer = function stepsReducer() {
  ...
  switch (action.type) {
    case _actions_todo_actions__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_TODOS_AND_STEPS"]:
      return action.payload.steps;

    case _actions_step_actions__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_STEPS"]:
      nextState = action.steps;
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _actions_todo_actions__WEBPACK_IMPORTED_MODULE_0__["RECEIVE_TODOS_AND_STEPS"]:
      // action.todos.forEach( todo => {
      //   nextState[todo.id] = todo;
      // });
      var todos = action.payload.todos;
      return Object.assign(nextState, todos);
