...
ActiveRecord::Base.transaction do
  ...
  # Wizards
  hagrid = User.create!(username: 'hagrid', age: 45, political_affiliation: "Giant", password: "password", email: "hagrid@hogwarts.io")
  harry = User.create!(username: 'harry', age: 11, political_affiliation: "Gryffindor", password: "password", email: "harry@hogwarts.io")
  hermione = User.create!(username: 'hermione', age: 11, political_affiliation: "Gryffindor", password: "password", email: "hermione@hogwarts.io")
  ron = User.create!(username: 'ron', age: 11, political_affiliation: "Gryffindor", password: "password", email: "ron@hogwarts.io")
  dumbledore = User.create!(username: "albus", age: 93, political_affiliation: "Headmaster", password: "password", email: "dumbledore@hogwarts.io")
  draco = User.create!(username: "draco", age: 11, political_affiliation: "Slytherin", password: "password", email: "draco@hogwarts.io")
  nimbus = User.create!(username: "nimbus", age: 45, password: "password", email: "brooms@nimbus.io", political_affiliation: "Nimbus")
  andy = User.create!(username: "andy", age: 100, password: "password", email: "andy@aa.io", political_affiliation: "Jedi")
