...
var receiveTodos = function receiveTodos(payload) {
  return {
    type: RECEIVE_TODOS,
    payload: payload
  };
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  return {
    steps: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_2__["stepsByTodoId"])(state.entities, todo_id),
    todo_id: todo_id
  };
};
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  // debugger;
  return {
    tags: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_4__["tagsByTodoId"])(state, ownProps.todo.id)
  };
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispatchToProps)(_todo_detail_view__WEBPACK_IMPORTED_MODULE_1__["default"]));
...
var mapStateToProps = function mapStateToProps(state) {
  return {
    todos: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_3__["allTodos"])(state.entities),
    errors: state.errors
  };
};
...
/* harmony import */ var _taggings_reducer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./taggings_reducer */ "./frontend/reducers/taggings_reducer.js");
...
var entitiesReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  ...
  taggings: _taggings_reducer__WEBPACK_IMPORTED_MODULE_6__["default"]
});
...
var rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  ...
  errors: _error_reducer__WEBPACK_IMPORTED_MODULE_1__["default"] // todos: todosReducer,
  // steps: stepsReducer,
  // users: usersReducer,
  // tags: tagsReducer,
...
/*!****************************************!*\
  !*** ./frontend/reducers/selectors.js ***!
  \****************************************/
/*! exports provided: allTodos, stepsByTodoId, tagsByTodoId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tagsByTodoId", function() { return tagsByTodoId; });
...
var tagsByTodoId = function tagsByTodoId(entities, todoId) {
  ...
  return Object.values(entities.taggings).filter(function (tagging) {
    return tagging.todo_id === todoId;
  }).map(function (tagging) {
    return entities.tags[tagging.tag_id];
  });
};
...
/***/ "./frontend/reducers/taggings_reducer.js":
/*!***********************************************!*\
  !*** ./frontend/reducers/taggings_reducer.js ***!
  \***********************************************/
/*! exports provided: default */
...
var taggingsReducer = function taggingsReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments.length > 1 ? arguments[1] : undefined;
  Object.freeze(state);
...
/* harmony default export */ __webpack_exports__["default"] = (taggingsReducer);
...
var configureStore = function configureStore() {
  ...
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers_root_reducer__WEBPACK_IMPORTED_MODULE_1__["default"], preloadedState, Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(_middleware_thunk_middleware__WEBPACK_IMPORTED_MODULE_2__["default"], redux_logger__WEBPACK_IMPORTED_MODULE_3__["logger"]));
};
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.currentUser) {
    ...
    store = Object(_store_store__WEBPACK_IMPORTED_MODULE_2__["default"])(preloadedState); // Clean up after ourselves so we don't accidentally use the
