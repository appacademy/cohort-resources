...
- There are different types of databases
	- How they store data and how is that data accessed
- We're will use a relational database model. 'Relational' refers to the use of tables to store and organize data
  - The tables can be related to each other, and are sometimes called `relations`
...
1. 	DataBase Management System
  	- An application that stores data and can be queried for data
...
* SQL is extremely popular: https://survey.stackoverflow.co/2023/#technology
...
- `HAVING` works like `WHERE`, but...
  ...
  - `HAVING` only filters aggregate data
