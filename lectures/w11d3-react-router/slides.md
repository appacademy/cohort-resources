...
calls to get data from our database, but not to get HTML.
...
+ `location`
  ...
  + Accessed in Route component as _this.props.location_.
+ `history`
...
Note:
- What are ownProps? Think back to our react-redux cycle when we used mapStatetoProps in our containers. 

- They are also passed down to the connected components.
---
