...
JavaScript code can react to these events via event _handlers_ or _listeners_ on DOM elements.
...
**A JS library that abstracts away a ton of DOM manipulation**
