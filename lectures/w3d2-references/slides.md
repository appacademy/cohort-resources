...
```ruby
def printGreeting(name)  # name is the parameter
	puts "Hello #{name}!"
end
  
ta1 = "Jack"
printGreeting(ta1)  # ta1 is the argument
...
* Correct Approach 1: `Array.new(3) { [] }`
* Correct Approach 2: `Array.new(3) { Array.new }`
