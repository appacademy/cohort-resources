...
Note:
- show example with `document.querySelectorAll('.markdown, pre').forEach(md => md.style.overflow = 'visible')` to get rid of scrollbars
---
...
+ [Super quick and painless list of web events](https://www.w3schools.com/jsref/dom_obj_event.asp)
...
Note:
- Example: target is like earthquake epicenter, currentTarget is like a sensor that detects the epicenter
