...
ActiveRecord::Schema.define(version: 2022_01_26_231524) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "coding_affiliation", null: false
    t.integer "age", null: false
    t.index ["coding_affiliation"], name: "index_users_on_coding_affiliation"
