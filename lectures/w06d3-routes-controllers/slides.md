...
+ HTTP:
    ...
    - HTTP requests and responses are in text format
...
![url-parts](https://aa-ch-lecture-assets.s3.us-west-1.amazonaws.com/routes-and-controllers/anatomy-of-url.png)
...
## Components of an HTTP Response
  ...
  * **Body** (e.g. actual HTML document, or data formatted as JSON)
   ...
   * [Yo, Dogg](https://httpstatusdogs.com/) 
