...
![http](https://aa-ch-lecture-assets.s3.us-west-1.amazonaws.com/routes-and-controllers/basic-http-request.png)
...
## Components of an HTTP Request
  * **Method (HTTP Verb)** (`GET`, `POST`) - describes what action to perform
  * **Path** (`/users`) - a string that specifies the resource being requested
  * **Query String** (`?loc=new+york` - _optional_) - may further specify the resource requested
...
![url-parts](https://aa-ch-lecture-assets.s3.us-west-1.amazonaws.com/routes-and-controllers/url-parts.png)
...
![restful-routes](https://aa-ch-lecture-assets.s3.us-west-1.amazonaws.com/routes-and-controllers/restful-routes.png)
