...
* How relevant is it to everyone?
* It is normal for us to deflect out of scope questions
...
- Follow the Driver / Navigator dynamic
  ...
  - The navigator explains what code they want to implement
- Take turns
	- Switch every 15 minutes (use a timer!)
  - Pause the timer if the navigator needs time to discuss strategy or you are asking a question / googling