...
- All of the lecture slides and code from the demo can be found in the `cohort-resources` repo on Github: https://github.com/appacademy/cohort-resources/tree/07-17-2023
...
1. Is it relevant to everyone?
2. Am I just showing off?
...
+ At this point it will be normal to not finish 
...
+ Do readings and homework in the alloted time
+ Look ahead at the project for the next day
	+ Do **not** start working on it
+ Assessment studying (if the practice materials are out)
...
+ Passing will allow you to continue
	+ no remaining fails
...
+ If you're stuck...
  1) Pause the timer
	...
	3) Test a few ideas with code (pry, byebug, print, etc)
	4) Google the error
	5) Call an instructor
