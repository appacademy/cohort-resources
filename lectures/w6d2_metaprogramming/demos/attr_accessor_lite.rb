...
#   end
# end
#class_eval takes in a block as an argument or a string as an argument


# We are creating an instance method for Human to call when the class is being created
Object.class_eval do #Can't define on Human because Human class has not been created yet
  # debugger
  def attribute_accessor_lite(*attribute_names)
    # debugger
