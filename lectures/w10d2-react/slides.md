...
![single-respond-rule](https://raw.githubusercontent.com/appacademy/worldwide-lecture-notes/master/react/w10d2-react/assets/react_single_respond_rule.png?token=ALXC6V3TVK6SNHEIT6SVCP3AMJJFM)
...
![react-dom-updates](https://raw.githubusercontent.com/appacademy/worldwide-lecture-notes/master/react/w10d2-react/assets/granular-dom-updates.gif?token=ALXC6V5BKT4SABACDZQ7YJTAMJJIE)
...
```js
<MyComponent name="Walker" hobby="reacting" />

// Somewhere in MyComponent (if class)
this.props.name; // => "Walker"
