...
# # Instructors
# elliot = User.create!(username: "all_knowing_elliot", age: 11, email: "those_are_teef@aa.io")
# ryan = User.create!(username: "will_climb_rocks", age: 11 , email: "boulderz@aa.io")
# dean = User.create!(username: "dean_machine", age: 11, email: "deans_diary@aa.io")
# angela = User.create!(username: "loves_capy", age: 11, email: "chosenone@aa.io")
# charlos = User.create!(username: "charlos_gets_buckets", age: 11, email: "ballin@aa.io")
# alissa = User.create!(username: "cow_luva", age: 11, email: "cows@aa.io")
# joe = User.create!(username: "trader_joes_4lyf3", age: 11, email: "thetraderjoe@aa.io")
# walker = User.create!(username: "wakka_wakka", age: 11, email: "wakka@wakka.walking")
# mike = User.create!(username: "like_mike", age: 11, email: "mike@aa.io")
# michelle = User.create!(username: "michelle_bell", age: 11, email: "michelle@aa.io")
# vanessa = User.create!(username: "the_vanessa", age: 11, email: "vanessa@aa.io")
# jen = User.create!(username: "jen_ken_intensifies", age: 11, email: "jen@aa.io")
# big_company = User.create!(username: "instructors_rock", age: 52, email: "giveus@money.now")
