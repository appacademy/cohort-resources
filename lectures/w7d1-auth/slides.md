...
* Advantage is in _precomputed_ values - saves the hacker time
* [200 Most Common Passwords in 2020](https://nordpass.com/most-common-passwords-list/)
...
* Don't focus on writing down or memorizing syntax during this lecture!
* The syntax is written out for you in the readings, the projects, and will also be in this demo for reference.
* During today's demo, focus on understanding what each method does and how they work together to implement the auth pattern!
...
## What does 'logged in' actually mean?
...
## How do we 'Log In' a user?

0. Have a form for the user to submit their username and password
0. Verify that it is the proper username and password
0. Store our user's `session_token` in the browser `session` cookie
---
