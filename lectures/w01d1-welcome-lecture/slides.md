...
+ Weeks 1 & 2 are remote
  + The workload will start ramping up starting Week 3, day 1.
  + W03D2 is the first day in person.
+ Weeks 4-16 are hybrid (2 days in person, 3 remote)
...
+ 9am - 12:20pm: Pairing on projects / Lectures (after W03D1)
...
+ 5:30pm - 6pm: Flex time / Study Hall / Announcements @6pm
	+ Some days flex time will start a bit earlier
...
+ Inform us before class (email: golden-gate-instructors@appacademy.io)
+ You are expected to do the work of the day
+ Strikes in this case can be removed if the work is submitted before next day
+ The limit are 3 sick days per student. If a life changing event does happen, we will take it case by case.
...
+ Progress Tracker check in at 1:30pm and 4pm
...
+ Do homework in the alloted time (check time estimate)
