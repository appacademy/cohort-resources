...
- All of the lecture slides and code from the demo can be found in the `cohort-resources` repo on Github: https://github.com/appacademy/cohort-resources/tree/05-10-2021/lectures
...
* Today's Material and Code Demos (2hr ~ 3hrs)
* Kahoot! Quiz
