...
a.push(2)
a
b # b was also changed by pushing onto a
old_a_id == a.object_id # true - we mutated `a`, we didn't reassign it
a.object_id == b.object_id # since we didn't reassign a, it's still referencing the same array as b, that's why b had also changed when we look at it
