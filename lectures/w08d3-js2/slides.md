...
Note:
* function style
* context is the window or global object
---
...
Note:
* method style
* context is the object that the function is being called on
---
...
Note: 
* constructor style
* context is an instance of the class

---

## Two more ways - Call & Apply

- `call` and `apply` are functions we invoke *on* a function
- Invokes the function with a different context
