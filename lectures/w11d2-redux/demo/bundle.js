...
/* harmony export */ });
var RECEIVE_TEA = 'RECEIVE_TEA'; // action
...
var teasReducer = function teasReducer() {
  ...
  var nextState = Object.assign({}, oldState); // creates a new object to be returned

  switch (action.type) {
    case _actions_tea_actions__WEBPACK_IMPORTED_MODULE_0__.RECEIVE_TEA:
      // this is when update the state with more tea
      // nextstate => {}
    ...
    default:
      // we dont want to change the tea slice of state
      return oldState;
  }
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var store = (0,_store_store__WEBPACK_IMPORTED_MODULE_0__.default)(); // creates the store
