...
* Universal
* Elements/[Psuedo-elements](https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-elements)
* Classes/Attributes/[Pseudo-classes](https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-classes)
* IDs
* Inline
* Important
...
* Universal (0,0,0,0)
* Elements/[Psuedo-elements](https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-elements) (0,0,0,1)
* Classes/Attributes/[Pseudo-classes](https://developer.mozilla.org/en-US/docs/Web/CSS/Pseudo-classes)(0,0,1,0)
* IDs (0,1,0,0)
* Inline (1,0,0,0)
* Important (1,0,0,0)
