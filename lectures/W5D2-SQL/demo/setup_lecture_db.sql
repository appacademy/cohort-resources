...
INSERT INTO
  possessions (id, name, cost, type, owner_id)
VALUES
  (34, 'atc device', 20, 'sport', 14);

INSERT INTO 
  possessions (id, name, cost, type, owner_id) 
VALUES
  (35, 'sfee bottle', 30, 'home', 15);

INSERT INTO 
  possessions (id, name, cost, type, owner_id)
VALUES
  (36, 'cheesecake', 30, 'home', 16);

INSERT INTO
  possessions (id, name, cost, type, owner_id)
VALUES
  (37, 'backpack', 59, 'outdoor', 13);

INSERT INTO 
  possessions (id, name, cost, type, owner_id)
VALUES
  (38, 'radio', 150, 'outdoor', 17);

INSERT INTO 
  possessions (id, name, cost, type, owner_id)
VALUES
  (39, 'hiking pole', 20, 'outdoor', 17);

INSERT INTO 
  possessions (id, name, cost, type, owner_id)
VALUES
  (40, 'theragun', 80, 'home', 16);

INSERT INTO
  possessions (id, name, cost, type, owner_id)
VALUES
  (41, 'birthday cake ice cream', 12, 'home', 14);

INSERT INTO 
  possessions (id, name, cost, type, owner_id) 
VALUES
  (42, 'laptop fan', 20, 'tech', 15);
