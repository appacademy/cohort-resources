...
![restful-routes](https://i.ibb.co/HFjkG5P/RESTful-routes.jpg)
...
![Rails](https://i.ibb.co/5sxWQTf/rails-diagram.png)
...
* `new` and `edit` routes simply render templates that contain forms!
