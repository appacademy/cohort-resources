...
ActiveRecord::Base.transaction do
  ...
  jordan = User.create!(username: 'Jordan')

  puts "Creating transactions..."

  # Green
  Transaction.create!(tea_id: green_tea.id, user_id: zack.id, quantity: 1)
  Transaction.create!(tea_id: green_tea.id, user_id: mike.id, quantity: 2)
  Transaction.create!(tea_id: green_tea.id, user_id: vanessa.id, quantity: 1)
  Transaction.create!(tea_id: green_tea.id, user_id: mike.id, quantity: 3)

  # Oolong
  Transaction.create!(tea_id: oolong_tea.id, user_id: mike.id, quantity: 1)
  Transaction.create!(tea_id: oolong_tea.id, user_id: walker.id, quantity: 1)
  ...
  # Earl Grey
  Transaction.create!(tea_id: earl_grey_tea.id, user_id: zack.id, quantity: 2)
  Transaction.create!(tea_id: earl_grey_tea.id, user_id: walker.id, quantity: 15)
  Transaction.create!(tea_id: earl_grey_tea.id, user_id: jordan.id, quantity: 2)
  
  # Rooibos
  Transaction.create!(tea_id: rooibos_tea.id, user_id: jordan.id, quantity: 2)
  Transaction.create!(tea_id: rooibos_tea.id, user_id: walker.id, quantity: 1)
  Transaction.create!(tea_id: rooibos_tea.id, user_id: jordan.id, quantity: 3)
  Transaction.create!(tea_id: rooibos_tea.id, user_id: vanessa.id, quantity: 2)
  Transaction.create!(tea_id: rooibos_tea.id, user_id: mike.id, quantity: 1)

  puts "Creating likes..."

  # Green
  Like.create!(tea_id: green_tea.id, user_id: jordan.id)
  Like.create!(tea_id: green_tea.id, user_id: zack.id)
  Like.create!(tea_id: green_tea.id, user_id: vanessa.id)
  Like.create!(tea_id: green_tea.id, user_id: walker.id)

  # Oolong
  Like.create!(tea_id: oolong_tea.id, user_id: mike.id)
  Like.create!(tea_id: oolong_tea.id, user_id: walker.id)

  # Earl Grey
  Like.create!(tea_id: earl_grey_tea.id, user_id: vanessa.id)
  Like.create!(tea_id: earl_grey_tea.id, user_id: zack.id)
  Like.create!(tea_id: earl_grey_tea.id, user_id: walker.id)

  # Rooibos
  Like.create!(tea_id: rooibos_tea.id, user_id: jordan.id)
  Like.create!(tea_id: rooibos_tea.id, user_id: vanessa.id)
  Like.create!(tea_id: rooibos_tea.id, user_id: mike.id)
