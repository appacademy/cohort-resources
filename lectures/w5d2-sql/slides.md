...
* `WHERE`/`WHERE NOT`: filters the data according to a logical expression
  - `IN/NOT IN`: checks for existence in a list
...
What if I wanted all instructors whose name started with "J"?

---

Query: Get the names of all App Academy instructors whose name starts with "J"
...
Query: How many types of possessions have a total cost over $200?
...
# [KAHOOT](https://play.kahoot.it/v2/?quizId=85da63ee-4075-42f8-94b3-2cd88de6915a)
