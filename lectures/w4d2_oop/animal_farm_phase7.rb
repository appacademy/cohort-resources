...
class Pig < Animal
    ...
    def break_leg
        puts "#{name} didn't see that coming..."
        @broken = true
    end

    def heal_leg
        puts "Thank goodness for modern pig medicine"
        @broken = false
    end
