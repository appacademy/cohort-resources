...
#### Mutable: state (value) can be modified after it is created
#### Immutable: state (value) cannot be modified after it is created
+ Mutable Types:
  + String, Array, Hash
+ Immutable Types:
...
* Instance variables (learn about during OOP)
* Class Variables (learn about during OOP)
