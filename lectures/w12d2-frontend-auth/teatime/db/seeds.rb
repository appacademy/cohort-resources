...
ActiveRecord::Base.transaction do
  ...
  ronil = User.create!(username: 'RoRo', password: 'password')
  jen = User.create!(username: 'JenKen', password: 'password')
  mike = User.create!(username: 'Mike "Madlad" Madsen', password: 'password')
  helen = User.create!(username: 'HELEN YU', password: 'password')
  michelle = User.create!(username: 'MishMosh', password: 'password')
  vanessa = User.create!(username: 'Vanz', password: 'password')
  walker = User.create!(username: 'Wakka', password: 'password')
  andy = User.create!(username: "Rayzah Blaydz", password: 'password')
