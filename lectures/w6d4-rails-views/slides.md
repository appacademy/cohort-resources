...
![1_pv-pmMPED1XuTtWlHd6b1g](https://user-images.githubusercontent.com/51456702/103372619-514d6880-4a87-11eb-97ea-ea0faec01fa7.png)
...
* HTML templates augmented with Ruby Code
  * Non-returning tags: `<% Ruby code here %>` - execute Ruby code without a return value 
  * Returning tags: `<%= Ruby code here %>` - executes Ruby code with a return value to be embedded into the template
