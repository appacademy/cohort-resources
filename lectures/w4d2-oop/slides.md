...
## Encapsulation cont.
- Ruby Example: Classes encapsulate logic/data from the rest of the application as they can only be accessed through that class 
...
- Can be called explicitly or implicitly (in older Ruby versions it could only be called implicitly to ensure it would always be called on `self`)
