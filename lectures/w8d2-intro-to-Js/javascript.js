...
// for an arr of numbers, return a new array where each element in the array is doubledr
...
// Declare Variables: 
let popStars;                        // declaration
let popStars = "Taylor Swift";       // initialization
const popStars = "Taylor Swift";     // initialization
// 

// global variable , dont want use this
...
const bestPopStar; // will throw error for not initializing const
const bestPopStar = "taylor Swift";
