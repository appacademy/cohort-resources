...
# Instructors
elliot = User.create!(username: "all_knowing_elliot", age: 11, coding_pref: "C", email: "those_are_teef@aa.io", password: "apples123")
ryan = User.create!(username: "will_climb_rocks", age: 11, coding_pref: "JavaScript", email: "boulderz@aa.io", password: "cherry123")
dean = User.create!(username: "dean_machine", age: 11, coding_pref: "Ruby", email: "deans_diary@aa.io", password: "echo123")
angela = User.create!(username: "loves_capy", age: 11, coding_pref: "JavaScript", email: "chosenone@aa.io", password: "echo123")
charlos = User.create!(username: "charlos_gets_buckets", age: 11, coding_pref: "Ruby", email: "ballin@aa.io", password: "echo123")
alissa = User.create!(username: "cow_luva", age: 11, coding_pref: "JavaScript", email: "cows@aa.io", password: "apple123")
joe = User.create!(username: "trader_joes_4lyf3", age: 11, coding_pref: "Ruby", email: "thetraderjoe@aa.io", password: "foxtrot123")
walker = User.create!(username: "wakka_wakka", age: 11, coding_pref: "JavaScript", email: "wakka@wakka.walking", password: "cherry123")
mike = User.create!(username: "like_mike", age: 11, coding_pref: "Ruby", email: "mike@aa.io", password: "foxtrot123")
michelle = User.create!(username: "michelle_bell", age: 11, coding_pref: "JavaScript", email: "michelle@aa.io", password: "berry123")
vanessa = User.create!(username: "the_vanessa", age: 11, coding_pref: "Ruby", email: "vanessa@aa.io", password: "berry123")
jen = User.create!(username: "jen_ken_intensifies", age: 11, coding_pref: "JavaScript", email: "jen@aa.io", password: "delta123")
big_company = User.create!(username: "instructors_rock", age: 52, coding_pref: "Instructors", email: "giveus@money.now", password: "cherry123")
