...
- All of the lecture slides and code from the demo can be found in the `cohort-resources` repo on Github: https://github.com/appacademy/cohort-resources
- Be sure to navigate to your cohort's branch (e.g., the branch named `07-06-2021`)
...
* Methods that are accessible to an _instance_ of a class - `self` is set to the instance that the method was called upon
...
#### Random Note
  we can refer to constants with the syntax ClassName::CONSTANT_NAME
---
