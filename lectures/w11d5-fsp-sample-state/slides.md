...
## Joins Tables Get Their Own Slice of State (Frontend vs Backend State) But Why???
...
- Go to Wiki tab
- You should already have the following pages:"
  - Main
  - MVP List
  - Schema
- Create a state shape page
- Paste in your markdown
  - remember to use tripple backticks followed by js to denote the language
    - `(ex: ```js {state shape object} ```)`

---

## Due Dates
* State Shape: W12D1 (Monday)
* All previously assigned design docs: W12D1 (Monday)
...
* [bluebird-wiki-example](https://github.com/appacademy/bluebird/wiki/sample-state)
