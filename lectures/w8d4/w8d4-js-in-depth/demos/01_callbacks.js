...
function feeder(callback){
    return callback()
}

console.log(feeder(function(){
    return interpolate("aloha")}))


console.log(sumTwoOperations(multiply,multiply,10,10));
console.log(sumTwoOperations(subtract, multiply, 10, 10))
