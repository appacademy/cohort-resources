...
* on average, cohorts score about 40% on this practice
* on average, cohorts score about 92% on the test on monday
* this practice is a learning opportunity to see where to improve, not just with the material but with test taking strategies
...
+ `git push --force <remote> <branch>`
  + or `-f` force option
  + use only if necessary (you are ok with overwriting the branch)
...
+ We will talk more about organizing your git repos tomorrow
