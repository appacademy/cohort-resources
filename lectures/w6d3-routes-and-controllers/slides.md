...
![http](https://raw.githubusercontent.com/appacademy/worldwide-lecture-notes/master/rails/w6d3-routes-controllers/assets/basic-http-request.png?token=AKKXTKJS4UTKE7KCNGSUONDA2LBSI)

---

+ When you type `www.google.com` in your url bar and hit `Enter`:
    1. Our computer (the client) sends an HTTP request to a server.
...
![url-parts](https://raw.githubusercontent.com/appacademy/worldwide-lecture-notes/master/rails/w6d3-routes-controllers/assets/url-parts.png?token=AKKXTKIAX6NOO7TL6QKFZDTA2LB2U)
...
![restful-routes](https://raw.githubusercontent.com/appacademy/worldwide-lecture-notes/master/rails/w6d3-routes-controllers/assets/restful-routes.png?token=AKKXTKIYAKDAJN7PI5FUOYDA2LCLS)
...
* Read your server log often!
    - You can see each request that was made to the server, as well as the response status
...
* Use Chrome Dev Tools' Network panel to gain additional information about a request
