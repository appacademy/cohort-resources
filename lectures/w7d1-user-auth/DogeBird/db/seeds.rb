...
# Users
mike = User.create!(username: 'michaelsoft', email: "pizzaman@msn.ca", favorite_coin: 'Ethereum', age: 99, password: "123456")
chris = User.create!(username: "chrismas", email: "tasty_chasetea@gmail.com", favorite_coin: 'Dogecoin', age: 11, password: "123456")
paulo = User.create!(username: 'paulito', email: 'newroom@aa.dev', favorite_coin: 'Dogecoin', age: 11, password: "123456")
abbey = User.create!(username: 'shmaybe', email: 'gale@geocities.com', favorite_coin: 'Ethereum', age: 11, password: "123456")
taylor = User.create!(username: 'taylor_made', email: 'craycray4taytay@hotmail.com', favorite_coin: 'Bitcoin', age: 3, password: "123456")
darren = User.create!(username: 'darelicte', email: 'capEtan@aa.io', favorite_coin: 'USD Coin', age: 79, password: "123456")
disnee = User.create!(username: 'disneeland', email: 'ilovedogs@yahoo.com', favorite_coin: 'Bitcoin', age: 19, password: "123456")
diego = User.create!(username: 'dieguccio', email: 'dieguccio@aol.org', favorite_coin: 'Bitcoin', age: 21, password: "123456")
