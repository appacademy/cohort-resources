...
+ if statements use parenthesis when comparing
...
* it is better to use strict equality to avoid false positives
...
>>variable declaration is different from 		variable assignment 
...
* passing a function as an argument to ANOTHER function. DONT PANIC!
